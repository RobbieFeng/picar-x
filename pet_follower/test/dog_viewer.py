"""Utility script that visualizes dog detections with bounding boxes."""
...
def main() -> None:  # pragma: no cover - requires hardware
    camera = CameraStream()
    detector = DogDetector()
    camera.start()

    if detector.model is None:
        raise RuntimeError("Failed to load YOLO model - install ultralytics and provide weights")
